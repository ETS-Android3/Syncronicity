...
MainActivity extends AppCompatActivity {
    ...
    //loads the toDoItems from a local file into an array list of toDoItems
    ...
    protected void printListList(String currentList){
        //show all of the available to do lists you can select
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Populate the navigation drawer header with the data from the users profile on firebase
        ...
        if (FirebaseAuth.getInstance().getCurrentUser() == null)
            ...
            if (FirebaseAuth.getInstance().getCurrentUser().getDisplayName() == null)
                ...
                loginName.setText("Welcome " + FirebaseAuth.getInstance().getCurrentUser().getDisplayName());
        }
        ...
        mDeleteListFAB.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                ...
                lists.remove("Default placeholder");
...
//        mRecyclerView.addOnScrollListener(customRecyclerScrollViewListener);
    ...
    //converts an array list into a string array
...
//    }
    ...
    public class BasicListAdapter extends RecyclerView.Adapter<BasicListAdapter.ViewHolder> implements ItemTouchHelperClass.ItemTouchHelperAdapter{
        ...
        public void onItemRemoved(final int position) {
            ...
            //deletes the item from the list and its associated notification
